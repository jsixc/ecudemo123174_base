					...
					if (data.comment != undefined && data.comment.length != undefined) {
						...
						for (var i=0; data.comment.length > i; i++) {
							...
							if (data.comment[i]['comment_reply_css'] == undefined) {
								...
								aHtml.push('<span class="grade '+data.use_point+'"><img src="/_jxc/imgx/commx/ico-point'+data.comment[i]['comment_point_count']+'.png" alt="'+data.comment[i]['comment_point_count']+'점" /></span>');
